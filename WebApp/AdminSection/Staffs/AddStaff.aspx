<%@ Page Title="Add Staff | Invoice Management" Language="C#" MasterPageFile="~/AdminSectionLayout.Master" AutoEventWireup="true" CodeBehind="AddStaff.aspx.cs" Inherits="WebApp.AdminSection.Staffs.AddStaff" %>
    ...
    <div class="row">
        <div class="col">
            ...
            <div class="form-group">
                ...
                <asp:ObjectDataSource ID="objStaffType" runat="server" SelectMethod="GetAll" TypeName="BusinessLogic.StaffTypeBL"></asp:ObjectDataSource>
            </div>
        </div>
    </div>
    <div class="row mt-3">
        <div class="col">
            <asp:Button ID="btnAdd" runat="server" OnClick="btnAdd_Click" CssClass="btn btn-success" Text="Add Staff" />
        </div>
    </div>
</asp:Content>
