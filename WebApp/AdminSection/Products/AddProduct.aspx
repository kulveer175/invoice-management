<%@ Page Title="Add Product | Invoice Management" Language="C#" MasterPageFile="~/AdminSectionLayout.Master" AutoEventWireup="true" CodeBehind="AddProduct.aspx.cs" Inherits="WebApp.AdminSection.Products.AddProduct" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="row">
        <div class="col">
            <asp:Button ID="btnAddClient" OnClick="btnAddClient_Click" runat="server" CssClass="btn btn-success" Text="Add Product" />
        </div>
    </div>
</asp:Content>
